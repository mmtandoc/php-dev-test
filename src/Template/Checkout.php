    ...
    protected function renderPage(Context $context): string
    {
        ...
        return <<<HTML
                <form method="post" accept-charset="utf-8" action="checkout" class="form" novalidate="novalidate">
                        ...
                        <div class="frame__contents">
                            <table class="order-summary">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="order-summary__product-thumbnail" src="/highres-assets/product.jpg"/>
                                        </td>
                                        <td>Lorem Widget</td>
                                        <td>1</td>
                                    </tr>
                            ...
                            <div class="form-field form-field--required">
                                ...
                                <div class="form-field__contents">
                                    <div class="textarea__container">
                                        <input type="text" name="billing_address_line1" id="billing_address_line1" class="entry" size="35" maxlength="255" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-field">
                                ...
                                <div class="form-field__contents">
                                    <div class="textarea__container">
                                        <input type="text" name="billing_address_line2" id="billing_address_line2" class="entry" size="35" maxlength="255" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-field form-field--required">
                    ...
                    <div>
                        <button class="submit-button" type="submit" title="Place Order">Place Order</button>
                    </div>
                </form>
HTML;
